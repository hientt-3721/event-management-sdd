...
import { signIn, signInWithEmail } from '@/features/auth/actions'
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-100 transition-colors"
      >
        ✉️ {t('signInWithEmail')}
      </button>
    </div>
